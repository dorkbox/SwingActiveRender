...
object Extras {
    ...
    const val id = "SwingActiveRender"
    const val vendor = "Dorkbox LLC"
    const val vendorUrl = "https://dorkbox.com"
    const val url = "https://git.dorkbox.com/dorkbox/SwingActiveRender"
}
